...
var desc = ''
if (Config.LANG == 'TR') desc = 'Instagramdan Video/Foto indirir'
if (Config.LANG == 'EN') desc = 'Downloads Video/Photo from Instagram.'
if (Config.LANG == 'AZ') desc = 'Instagramdan Video/Foto yükləyər'
if (Config.LANG == 'RU') desc = 'Скачивает Видео / Фото из Instagram.'
if (Config.LANG == 'ES') desc = 'Descargas video / foto de Instagram.'
if (Config.LANG == 'PT') desc = 'Downloads de vídeo / foto do Instagram.'
if (Config.LANG == 'ML') desc = 'ഇൻസ്റ്റാഗ്രാമിൽ നിന്ന് വീഡിയോ/ഫോട്ടോ ഡൗൺലോഡ് ചെയ്യുക.'
if (Config.LANG == 'HI') desc = 'इंस्टाग्राम से वीडियो/फोटो डाउनलोड करें।.'
if (Config.LANG == 'ID') desc = 'Unduh video/foto dari Instagram.'

Asena.addCommand({ pattern: 'ig ?(.*)', fromMe: wk, desc: desc }, async (message, match) => {
    ...
    if (type === 'image') { await message.sendMessage(data, MessageType.image, { caption: "Made By WhatsAsena" }) }
